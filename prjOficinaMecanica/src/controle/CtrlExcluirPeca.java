...
public class CtrlExcluirPeca implements ICtrlCasoDeUso {
	//
	// ATRIBUTOS
	//
	public enum Status {
	 ...
	 */
	public CtrlExcluirPeca(CtrlManterPecas ctrl, Peca p) throws ControleException, DadosException {
...
//		// Notifico ao controlador do programa o término deste caso de uso
		ctrlManterPeca.terminarCasoDeUsoExcluirPeca();
	}
